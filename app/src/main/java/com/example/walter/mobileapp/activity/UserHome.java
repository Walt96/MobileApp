...
public class UserHome extends AppCompatActivity
    ...
    ArrayList<com.example.walter.mobileapp.object.Notification> notifications;
    Lock lock;
    ...
    //carico i dati del profilo dell'utente
    ...
    //carichiamo le eventuali notifiche
        ...
        StaticInstance.getInstance().collection("invite").whereEqualTo("invited", username).whereEqualTo("readTo", false).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    com.example.walter.mobileapp.object.Notification notification = new com.example.walter.mobileapp.object.Notification(id, from, to, state, info_match, match, role, team, date, time, (boolean) document.get("covered"), address);
    ...
    //mando la notifica con gli intent da invocare in base alla risposta dell'utente alla notifica
    ...
    //aggiungo un listener per restare in ascolto di eventuali notifiche da mandare all'utente
    ...
    //adapter per creare una lista di news sulla home dell'utente
    class CustomAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final com.example.walter.mobileapp.object.Notification notification = notifications.get(position);

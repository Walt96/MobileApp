...
import com.example.walter.mobileapp.DLVintegration.ChoosedResult;
import com.example.walter.mobileapp.DLVintegration.NotAvailable;
import com.example.walter.mobileapp.DLVintegration.Pitch;
import com.example.walter.mobileapp.DLVintegration.Time;
...
public class AiHelper extends AppCompatActivity {
    ...
    HashMap<String, com.example.walter.mobileapp.object.Pitch> pitchesSelectedByAI;
        ...
        StaticInstance.db.collection("pitch").document(code.substring(1, code.length() - 1)).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    final com.example.walter.mobileapp.object.Pitch toAdd = new com.example.walter.mobileapp.object.Pitch(address + ", " + city, price, covered, "");
    ...
    class CustomAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final com.example.walter.mobileapp.object.Pitch currentPitch = pitchesSelectedByAI.get(matchSelectedByAI.get(position).getPitchcode());

            //perche nel layout originale c'è booking che ora non serve
            ((TextView) (convertView.findViewById(R.id.bookingby_))).setText(R.string.Price);
        ...
        private void bookPitch(String pitchcode, com.example.walter.mobileapp.object.Pitch current, String date, String time) {
